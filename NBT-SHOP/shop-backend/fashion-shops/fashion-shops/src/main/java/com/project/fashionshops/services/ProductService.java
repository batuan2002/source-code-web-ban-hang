...
import com.project.fashionshops.repositories.CategoryRepository;
import com.project.fashionshops.repositories.ProductImageRepository;
...
public class ProductService implements IProductService {
    ...
    public Product createProduct(ProductDTO productDTO) throws DataNotFoundException {
        Category existingCategory = categoryRepository.findById(productDTO.getCategoryId())
                .orElseThrow(() -> new DataNotFoundException
                        ("không tìm thấy danh mục category id:"
    ...
    public Product getProductById(long productId) throws Exception {
        return productRepository.findById(productId)
                .orElseThrow(() -> new DataNotFoundException("không tìm thấy danh mục product id" + productId));
    }
    ...
    public Product updateProduct(long id, ProductDTO productDTO) throws Exception {
       ...
       if (existingProduct != null){
           ...
           Category existingCategory = categoryRepository
                   ...
                   .orElseThrow(() ->
                           new DataNotFoundException("không tìm thấy danh mục category id" + productDTO.getCategoryId()));
...
optionalProduct.ifPresent(productRepository::delete);
    ...
    public ProductImage createProductImage(
        ...
        // kiem tra xem da co sp chua moi cho anh vao
        Product existingProduct = productRepository
                .findById(productId)
                .orElseThrow(() -> new DataNotFoundException
                        ("không tim thấy danh mục category id "
...
if (size >= ProductImage.MAXIMUM_IMAGES_PER_PRODUCT){
    throw  new InvalidParamException("Number of images be <="  +ProductImage.MAXIMUM_IMAGES_PER_PRODUCT);
}
